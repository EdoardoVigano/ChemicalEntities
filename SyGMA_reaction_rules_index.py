...
def all_index_atoms(molecule: Chem.rdchem.Mol):
    ...
    idx = [ np.array(REACTION_N_dealkylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_10(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_11(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_12(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_13(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_14(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_15(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_16(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_17(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_18(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_19(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_20(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_dealkylation_21(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_demethylation_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_dealkylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_10(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_ aromatic hydroxylation_11(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_carboxylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_carboxylation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_carboxylation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_carboxylation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_carboxylation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_10(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_11(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_12(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_13(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aliphatic_hydroxylation_14(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_benzylic_hydroxylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_benzylic_hydroxylation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_benzylic_hydroxylation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_benzylic_hydroxylation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_benzylic_hydroxylation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_benzylic_hydroxylation_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_reduction_9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aldehyde_oxidation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_aldehyde_oxidation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_O_deacetylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_deacetylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_decarboxylation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_decarboxylation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_decarboxylation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydrogenation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydrogenation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydrogenation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydrogenation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydrogenation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydrogenation_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydrogenation_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydration_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydration_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehydration_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_primary_alcohol_oxidatyion_to_carboxyl_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_primary_alcohol_oxidatyion_to_carboxyl_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_secondary_alcohol_oxidation_to_carbonyl_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_secondary_alcohol_oxidation_to_carbonyl_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_S_oxidation_9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_epoxide_hydrolysis_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_epoxide_hydrolysis_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_oxidative_deamination_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_oxidative_deamination_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_oxidative_deamination_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_oxidative_deamination_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_nitro_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_nitro_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_nitro_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehalogenation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehalogenation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehalogenation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_dehalogenation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_1a(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_1b(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_1c(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_2a(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_2b(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_2c(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_3a(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_3b(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_3c(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_3d(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_5a(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_5b(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_5c(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_5d(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_6a(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_6b(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_6c(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_condensation_6d(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_hydrolysis_10(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_oxidation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_oxidation_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_oxidation_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_oxidation_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_N_oxidation_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_acetyl_shift_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_tautomerisation_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_10(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_11(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_12(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_13(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_14(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_special_rules_15(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_steroids_1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(REACTION_steroids_2(molecule)[1]).reshape(1,-1).tolist()[0]]
