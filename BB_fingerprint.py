...
def descriptor(mol: Chem.rdchem.Mol):
    ...
    if mol != 'none':
        f_SA1.append(f_SA1(mol))
        f_SA2.append(f_SA2(mol))
        f_SA3.append(f_SA3(mol))
        f_SA4.append(f_SA4(mol))
        f_SA5.append(f_SA5(mol))
        f_SA6.append(f_SA6(mol))
        f_SA7.append(f_SA7(mol))
        f_SA8.append(f_SA8(mol))
        f_SA9.append(f_SA9(mol))
        f_SA10.append(f_SA10(mol))
        f_SA11.append(f_SA11(mol))
        f_SA12.append(f_SA12(mol))
        f_SA13.append(f_SA13(mol))
        f_SA14.append(f_SA14(mol))
        f_SA15.append(f_SA15(mol))
        f_SA16.append(f_SA16(mol))
        f_SA17.append(f_SA17(mol))
        f_SA18.append(f_SA18(mol))
        f_SA19.append(f_SA19(mol))
        f_SA20.append(f_SA20(mol))
        f_SA21.append(f_SA21(mol))
        f_SA22.append(f_SA22(mol))
        f_SA23.append(f_SA23(mol))
        f_SA24.append(f_SA24(mol))
        f_SA25.append(f_SA25(mol))
        f_SA26.append(f_SA26(mol))
        f_SA27.append(f_SA27(mol))
        f_SA28.append(f_SA28(mol))
        f_SA29.append(f_SA29(mol))
        f_SA30.append(f_SA30(mol))
        f_SA31a.append(f_SA31a(mol))
        f_SA31b.append(f_SA31b(mol))
        f_SA31c.append(f_SA31c(mol))
        f_SA37.append(f_SA37(mol))
        f_SA38.append(f_SA38(mol))
        f_SA39.append(f_SA39(mol))
        f_SA40.append(f_SA40(mol))
        f_SA41.append(f_SA41(mol))
        f_SA42.append(f_SA42(mol))
        f_SA43.append(f_SA43(mol))
        f_SA44.append(f_SA44(mol))
        f_SA45.append(f_SA45(mol))
        f_SA46.append(f_SA46(mol))
        f_SA47.append(f_SA47(mol))
        f_SA48.append(f_SA48(mol))
        f_SA49.append(f_SA49(mol))
        f_SA50.append(f_SA50(mol))
        f_SA51.append(f_SA51(mol))
        f_SA52.append(f_SA52(mol))
        f_SA53.append(f_SA53(mol))
        f_SA54.append(f_SA54(mol))
        f_SA55.append(f_SA55(mol))
        f_SA56.append(f_SA56(mol))
        f_SA57.append(f_SA57(mol))
    else:
        for chem_group in lst_chemical_BB:
            chem_group.append('none')
    
    # Spoatsato SA17 PRIMA DEL S18
    ...
    columns=['f_SA1','f_SA2','f_SA3','f_SA4','f_SA5','f_SA6','f_SA7','f_SA8','f_SA9','f_SA10',
             'f_SA11','f_SA12','f_SA13','f_SA14','f_SA15','f_SA16','f_SA17','f_SA18','f_SA19','f_SA20','f_SA21','f_SA22','f_SA23',
